...
dictionary = p1.bag_of_words_with_stopwords(train_texts, stopwords)
...
print("Most Impactful Unigrmas in predicting positive labels")
print(sorted_word_features[:10])

print("Most Impactful Unigrmas in predicting negative labels")
